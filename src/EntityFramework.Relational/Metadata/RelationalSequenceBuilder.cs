...
namespace Microsoft.Data.Entity.Relational.Metadata
{
    public class RelationalSequenceBuilder
    {
        ...
        private readonly Action<Sequence> _modelUpdater;

        public RelationalSequenceBuilder(
            [NotNull] Sequence sequence,
            [NotNull] Action<Sequence> modelUpdater)
        {
            Check.NotNull(sequence, nameof(sequence));
            Check.NotNull(modelUpdater, nameof(modelUpdater));
